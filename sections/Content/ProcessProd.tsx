  ...
  return (
    <>
      <div class="flex flex-row items-center justify-start w-full odd:flex-row-reverse">
        ...
        <div>
          <h3
            class={`uppercase text-[13px] leading-[18px] mx-5 tracking-wider text-primary`}
          >
            {title}
          </h3>
          {description &&
...
function ProcessProd({ title, cards }: Props) {
  ...
  return (
    <div class={`py-[30px] bg-base-200`}>
      ...
      >
        <h2
          class={`title-line uppercase text-xl py-2.5 px-4 mb-4 mx-[50px] text-primary text-center leading-6 bg-base-200`}
        >
          {title}
        </h2>
